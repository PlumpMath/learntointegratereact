...
var or__4563__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__4563__auto__)){
return or__4563__auto__;
} else {
var or__4563__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__4563__auto____$1)){
return or__4563__auto____$1;
} else {
var or__4563__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__4563__auto____$2)){
return or__4563__auto____$2;
} else {
var or__4563__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__4563__auto____$3)){
return or__4563__auto____$3;
} else {
...
var n__5466__auto__ = a.length;
var i = (0);
while(true){
if((i < n__5466__auto__)){
var c_7871 = (a[i]);
if((c_7871["cljsIsDirty"]) === true){
(c_7871["forceUpdate"])();
} else {
}
...
var G__7873 = ((function (this$){
return (function (){
return this$.run_queues();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__7873) : reagent.impl.batching.next_tick.call(null,G__7873));
}
});
...
var temp__4429__auto___7875 = (this$["componentQueue"]);
if((temp__4429__auto___7875 == null)){
} else {
var cs_7876 = temp__4429__auto___7875;
(this$["componentQueue"] = null);

reagent.impl.batching.run_queue(cs_7876);
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__5161__auto__,writer__5162__auto__,opt__5163__auto__){
return cljs.core._write(writer__5162__auto__,"reagent.impl.batching/RenderQueue");
});
