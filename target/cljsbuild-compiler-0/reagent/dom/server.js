...
var or__4563__auto__ = reagent.dom.server.imported = require("react-dom/server");
...
var _STAR_non_reactive_STAR_8216 = reagent.impl.util._STAR_non_reactive_STAR_;
...
}finally {reagent.impl.util._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_8216;
}});
/**
...
var _STAR_non_reactive_STAR_8218 = reagent.impl.util._STAR_non_reactive_STAR_;
reagent.impl.util._STAR_non_reactive_STAR_ = true;

try{return (reagent.dom.server.module()["renderToStaticMarkup"])(reagent.impl.template.as_element(component));
}finally {reagent.impl.util._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_8218;
}});
